...
function RightEntryV1400(props) {
  ...
  <ul className='flex-none flex justify-center items-center'>
    ...
    <div className='flex-auto mx-2 text-white'>
      <li>
        {/* 大会员 */}
        <a href={local_website} className="flex flex-col justify-center item-center shrink-0">
          <svg className="ml-auto mr-auto w-5 h-5">
    ...
    <li className='flex-auto mx-1.5 p-2 text-white bg-pink-fb7299 rounded-lg'>
      ...
      <div>
        <a href={local_website}>
          <div className="flex ml-2 mr-2.5">
            <svg className="w-5 h-5 p-px pt-0.5">
...
export default RightEntryV1400;